...
part of 'contract_template.dart';
...
const TemplateSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'sphere': IndexSchema(
      id: 8589287800754370523,
      name: r'sphere',
      unique: false,
      replace: false,
      properties: [
...
const _TemplatesphereEnumValueMap = {
  'it': 0,
  'logistics': 1,
  'universal': 2,
};
const _TemplatesphereValueEnumMap = {
  0: TemplateSphere.it,
  1: TemplateSphere.logistics,
  2: TemplateSphere.universal,
};
...
extension TemplateQueryWhereSort on QueryBuilder<Template, Template, QWhere> {
  ...
  QueryBuilder<Template, Template, QAfterWhere> anySphere() {
    return QueryBuilder.apply(this, (query) {
...
extension TemplateQueryWhere on QueryBuilder<Template, Template, QWhereClause> {
  ...
  QueryBuilder<Template, Template, QAfterWhereClause> codeEqualTo(String code) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterWhereClause> codeNotEqualTo(
      String code) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Template, Template, QAfterWhereClause> sphereEqualTo(
      TemplateSphere sphere) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'sphere',
        value: [sphere],
  ...
  QueryBuilder<Template, Template, QAfterWhereClause> sphereNotEqualTo(
      TemplateSphere sphere) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Template, Template, QAfterWhereClause> sphereGreaterThan(
    TemplateSphere sphere, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterWhereClause> sphereLessThan(
    TemplateSphere sphere, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterWhereClause> sphereBetween(
    TemplateSphere lowerSphere,
    TemplateSphere upperSphere, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension TemplateQueryFilter
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> codeEqualTo(
    String value, {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> codeGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> codeLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> codeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> codeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> codeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> codeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> codeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> codeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'code',
        value: '',
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> codeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'code',
        value: '',
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> sphereEqualTo(
      TemplateSphere value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'sphere',
        value: value,
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> sphereGreaterThan(
    TemplateSphere value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> sphereLessThan(
    TemplateSphere value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> sphereBetween(
    TemplateSphere lower,
    TemplateSphere upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension TemplateQuerySortBy on QueryBuilder<Template, Template, QSortBy> {
  QueryBuilder<Template, Template, QAfterSortBy> sortByCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.asc);
    });
  }

  QueryBuilder<Template, Template, QAfterSortBy> sortByCodeDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterSortBy> sortBySphereDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sphere', Sort.desc);
    });
  }
...
extension TemplateQuerySortThenBy
  ...
  QueryBuilder<Template, Template, QAfterSortBy> thenByCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.asc);
    });
  }

  QueryBuilder<Template, Template, QAfterSortBy> thenByCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.desc);
    });
  }
  ...
  QueryBuilder<Template, Template, QAfterSortBy> thenBySphere() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sphere', Sort.asc);
    });
  }

  QueryBuilder<Template, Template, QAfterSortBy> thenBySphereDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sphere', Sort.desc);
    });
  }
...
extension TemplateQueryWhereDistinct
  ...
  QueryBuilder<Template, Template, QDistinct> distinctByCode(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TemplateQueryProperty
  ...
  QueryBuilder<Template, String, QQueryOperations> codeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, TemplateSphere, QQueryOperations> sphereProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'sphere');
    });
  }
